...
@Database(entities = [StallData::class,StallItemsData::class, MiscEventsData::class,
    ...
    FavNamesData::class, TicketsData::class, UserShows::class, TicketsCart::class,
    PlayerRankingResponse::class, EventData::class, CategoryData::class, VenueData::class],version = 2)
